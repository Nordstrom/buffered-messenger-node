...
function BufferMessenger (options) {
  var self = this
...
/**
 * Send a message to BufferMessenger
 * @param message {Object} The constructed message without tags
 */
BufferMessenger.prototype.send = function (message) {
  var self = this
 ...
 * @param message {Object} The constructed message without tags
 */
BufferMessenger.prototype.enqueue = function (message) {
  var self = this
 ...
 */
BufferMessenger.prototype.flushQueue = function () {
  var self = this
 ...
 */
BufferMessenger.prototype._send = function (messages) {
 ...
 */
BufferMessenger.prototype.onBufferFlushInterval = function () {
  var self = this
  return self.flushQueue()
}
 ...
 */
BufferMessenger.prototype.close = function () {
  var self = this
...
module.exports = BufferMessenger
